...
/**
 * @extends ServiceEntityRepository<Paraclinique>
 *
...
class ParacliniqueRepository extends ServiceEntityRepository
{
    ...
    public function save(Paraclinique $entity, bool $flush = false): void
    {
    ...
    public function remove(Paraclinique $entity, bool $flush = false): void
    {
