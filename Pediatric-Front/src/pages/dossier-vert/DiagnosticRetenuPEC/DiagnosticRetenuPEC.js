...
import {
    useAddDiagnosticRetenuPecMutation
} from "../../../services/PatientService/dossiers-vert-service/diagnostic-retenu-pec/addDiagnosticRetenuPecApi";
// project import
...
import {
    useAddAntiPersonnelMutation
} from "../../../services/PatientService/dossiers-vert-service/anti-personnel-api/addAntiPersonnelApi";
...
function DiagnosticRetenuPEC() {
    ...
    const [addDiagnosticRetenuPec, { isLoading, isError, error }] = useAddDiagnosticRetenuPecMutation();
        ...
        <Formik
            ...
            onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                try {
                    ...
                    const response = await addDiagnosticRetenuPec({ body: values, token: token });
