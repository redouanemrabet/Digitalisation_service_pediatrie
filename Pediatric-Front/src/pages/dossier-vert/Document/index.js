...
import ImgMedical from '../../../assets/images/document/medical.jpg';
import ImageGoal from '../../../assets/images/document/goal.jpg';
import { Link } from 'react-router-dom';
...
import Paper from "@mui/material/Paper";
const documentList = [
  { image: ImgMedical, description: 'scanner heart girl' },
  { image: ImageGoal, description: 'the first image' },
  { image: ImageGoal, description: 'the second image' },
  { image: ImageGoal, description: 'the third image' },
  { image: ImageGoal, description: 'the 4 image' },
//   { image: ImageGoal, description: 'the 5 image' },
];
const Item = styled(Paper)(({ theme }) => ({
  backgroundColor: theme.palette.mode === 'dark' ? '#1A2027' : '#fff',
  ...theme.typography.body2,
...
export default function Document() {
  ...
  const handleDocumentClick = (imageUrl) => {
        ...
        <Grid container spacing={2} justifyContent="center">
          <Grid item xs={12} md={11}>
            <Item>
              ...
              {!fullscreenImage && (
                <Grid container   >
                  <Grid container alignItems="center" sx={{backgroundColor: '#ffffff', width: '100%',boxShadow: 'rgba(100, 100, 111, 0.2) 0px 7px 29px 0px', padding: '10px' ,marginBottom:"20px"}}>
                    <Grid item xs={6}>
                  ...
                  <Grid container spacing={2}  justifyContent="center" alignItems="center" sx={{marginLeft:'20px'}}>
                    {documentList.map((document, index) => (
                      <Card key={index} sx={{ maxWidth: 400, width: '100%', height: '350px', margin: '10px' ,boxShadow: 'rgba(100, 100, 111, 0.2) 0px 7px 29px 0px'}}>
                        <CardContent>
                          <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
                            <ListItemIcon>
                              <MedicalServicesOutlined style={{ color: '#00bfff' }}  />
                            </ListItemIcon>
                            <Typography variant="h6" component="div" color="primary">
                              {document.description}
                            </Typography>
                          </div>
                          <img src={document.image} alt="image" style={{ width: '100%', height: '200px', objectFit: 'cover', marginTop: '10px' }} />
              ...
              {fullscreenImage && (
                <Grid container spacing={2} justifyContent="center" alignItems="center">
                  <img src={fullscreenImage} alt="fullscreen" style={{ width: '100vw', height: '100vh', objectFit: 'contain' }} />
