...
import { useAddExamenPhysiqueMutation } from '../../../services/PatientService/dossiers-vert-service/examen-physique-api/addExamenPhysiqueApi';
...
function ExamenPhysique() {
    ...
    const [addExamenPhysique, { isLoading, isError, error }] = useAddExamenPhysiqueMutation();
    ...
    return (
        <Formik
            ...
            onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                try {
                    const response = await addExamenPhysique({ body: values, token: token });
                                            ...
                                            <Box sx={{ flexGrow: 1 }}>
                                                <Grid container spacing={2}>
                                                    <Grid item xs={12} md={12}>
                                                        <FormLabel id="AnomaliesLigneMediane">Anomalies de la ligne médiane :</FormLabel>
                                                    </Grid>
                                                </Grid>
                                            </Box>
                                            <br></br>
