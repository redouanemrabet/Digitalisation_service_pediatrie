...
function UpdateAntiPersonnel() {
    ...
    const { data: antiPersonnel, isLoading: isLoadingQuery, isError ,refetch} = useGetAntiPersonnelQuery({ token: token, id: formId });

    const [UpdateAntiPersonnelMutation, { isSuccess, isLoading: isLoadingMutation, isError: isErrorMutation, error, data }] =
        useUpdateAntiPersonnelMutation();
                    ...
                    <Item>
                        ...
                        {isLoadingQuery ? (
                          ...
                          <Alert severity="error" color="error" sx={{ width: '100%' }}>
                            ...
                            <Formik
                                initialValues={{
                                    Consanguinite: antiPersonnel.Consanguinite,
                                    Grossesse: antiPersonnel.Grossesse,
                                    AccouchementVoie: antiPersonnel.AccouchementVoie,
                                    Incidents: antiPersonnel.Incidents,
                                    Incident: antiPersonnel.Incident,
                                    Terme: antiPersonnel.Terme,
                                    Poids: antiPersonnel.Poids,
                                    Taille: antiPersonnel.Taille,
                                    PC: antiPersonnel.PC,
                                    Allaitement: antiPersonnel.Allaitement,
                                    DiversificationAlimentaire: antiPersonnel.DiversificationAlimentaire,
                                    DeveloppementPsychomoteur: antiPersonnel.DeveloppementPsychomoteur,
                                    PathologieNeonatale: antiPersonnel.PathologieNeonatale,
                                    PathologieChronique: antiPersonnel.PathologieNeonatale,
                                    Traitement: antiPersonnel.Traitement,
                                    ContextePsychoAffectif: antiPersonnel.ContextePsychoAffectif
                                }}
                                ...
                                onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                                    try {
                                        await UpdateAntiPersonnelMutation({ body: values, token: token, id: formId });
...
export default UpdateAntiPersonnel;
